...
<body>
    ...
    <section class="container">
        ...
        <img src="./Screenshot 2025-05-05 135009.png" alt="Restaurant Banner" style="width: 30%; border-radius: 10px;">
    </section>

    <footer>
        <div class="container">
            <p>&copy; 2025 DKS BAKERY| Designed by DHARANI SREE P (24900674) </p>
        </div>
    </footer>
</body>
...
<footer>
    <p>&copy; 2025 Designed by DHARANI SREE P (24900674)</p>
</footer>
</body>
</html>
menu.html
...
<body>
    ...
    <div class="menu-container">
        <div class="menu-item">
            <img src="./bcroiss.png" alt="Croissant">
            <div>
        ...
        <div class="menu-item">
            <img src="./acroiss.png" alt="Croissant1">
            <div>
        ...
        <div class="menu-item">
            <img src="./expresso.png" alt="Coffee">
            <div>
                <h3>EXPRESSO</h3>
...
<div class="admin-container">
    <div class="admin-card">
        <img src="./zaara.png" alt="Dirtector">
        <h3> ZAARA</h3>
    ...
    <div class="admin-card">
        <img src="./vikas.png" alt="Sous Chef">
        <h3>VIKAS KHANNA </h3>
        <p>General Manager</p>
    </div>
    <div class="admin-card">
    ...
    <div class="admin-card">
        <img src="./pierre.png" alt="Receptionist">
...
![alt text](<Screenshot 2025-05-07 045953-1.png>)
![alt text](<Screenshot 2025-05-07 051839-2.png>)
![alt text](<Screenshot 2025-05-07 050021-1.png>)
![alt text](<Screenshot 2025-05-07 050030-1.png>)
